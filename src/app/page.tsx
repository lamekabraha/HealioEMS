...
export default function Home() {
  return (
    <main>
      <div 
        className="BACKGROUND inset-0 bg-cover bg-repeat bg-blend-multiply"
        style={{
      ...
      >
        ...
        <div className="MAIN gap-3 mx-60">
          ...
          <div className="INFO flex flex-row">
            <div className="SCHEDULE justify-center border-1 border-softBlue bg-softBlue opacity-80 text-center my-5 mr-2.5 p-5 rounded-2xl w-3/5">
